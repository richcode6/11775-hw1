...
ffmpeg_path =/data/ASR5/ramons_2/tools/ffmpeg-3.2.4/build
export PATH="/home/ramons/tools/ffmpeg-3.2.4/build/bin:$PATH"
export LD_LIBRARY_PATH="/data/ASR1/tools/ffmpeg-3.2.4/libs/:$LD_LIBRARY_PATH"
export PATH=$opensmile_path/bin:$PATH
export LD_LIBRARY_PATH=$opensmile_path/lib:$LD_LIBRARY_PATH

# Two additional variables
video_path=/data/VOL4/sshalini/data/speech-kitchen.org/sdalmia/11775_videos/video
   # path to the directory containing all the videos. In this example setup, we are linking all the videos to "../video"
